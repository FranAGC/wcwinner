                          ...
                          <tbody>
                            {groupTeams.map((team, idx) => (
                              <tr key={team.team_id} style={{ borderBottom: idx < 3 ? '1px solid rgba(255,255,255,0.03)' : 'none', background: idx < 2 ? 'rgba(0, 255, 170, 0.01)' : 'transparent' }}>
                                <td style={{ padding: '10px 8px', fontWeight: idx < 2 ? 600 : 400, display: 'flex', alignItems: 'center', gap: '8px' }}>
                          ...
                          <tbody>
                            {eloRankings.map((r, i) => (
                              <tr key={r.team_id} style={{ borderBottom: '1px solid rgba(255,255,255,0.02)' }}>
                                <td style={{ padding: '6px' }}>{i + 1}. {teamsMap[r.team_id] || r.team_id}</td>
                      ...
                      <div style={{ maxHeight: '350px', overflowY: 'auto' }}>
                        <table style={{ width: '100%', fontSize: '0.85rem' }}>
                          <tbody>
                            {fifaRankings.map((r) => (
                              <tr key={r.team_id} style={{ borderBottom: '1px solid rgba(255,255,255,0.02)' }}>
                                <td style={{ padding: '6px' }}>{r.rank}. {teamsMap[r.team_id] || r.team_id}</td>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: '6px', fontSize: '0.85rem' }}>
                              ...
                              <div style={{ display: 'flex', justifyContent: 'space-between', borderTop: '1px solid var(--border-color)', paddingTop: '6px', marginTop: '4px' }}>
                                ...
                                <span style={{ fontWeight: 700, color: 'var(--accent-gold)' }}>
                                  {prediction.most_likely_score} ({Math.round(prediction.most_likely_score_prob * 100)}%)
                                </span>
                              </div>
                            </div>
                          </div>
